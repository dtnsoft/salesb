...
public  class  C_PP_CLI_T
{
    ...
    private  String      m_c_strLogPath     = "";															// 사용자 로그 변수추가 - 2013. 09. 04
    ...
    /* -------------------------------------------------------------------- */
/*
    native   byte[]      mf_PAYPLUS_DL__do_tx( String  parm_c_strHomeDir,
                                               String  parm_c_strSiteID,
                                               String  parm_c_strTxCD,
                                               String  parm_c_strSiteKey,
                                               String  parm_c_strPubKey,
                                               String  parm_c_strKCPPGSvr,
                                               int     parm_nKCPPGPort,
                                               byte[]  parm_c_strOrdr_IDxx,
                                               byte[]  parm_c_strEncData,
                                               byte[]  parm_c_strComData,
                                               int     parm_nLogLevel,
                                               int     parm_nOpt         );
*/


    public  void    mf_init( String  parm_c_strHomeDir,
                             String  parm_c_strPAURL,
                             String  parm_c_strPAPorts,
                             int     parm_nTxMode    )
    {
        this.m_bSetEnv = true;
    ...
    public  void    mf_set_us( int     parm_nSetNo,
                               String  parm_c_strName,
    ...
    public  void    mf_set_gs( int     parm_nSetNo,
                               String  parm_c_strName,
                               String  parm_c_strVal )
    {
        if ( parm_c_strVal != null && parm_c_strVal.length() != 0 )
    ...
    public  void    mf_add_rs( int  parm_nNameSetNo,
                               int  parm_nValSetNo )
    {
        this.m_c_straReqData[ parm_nNameSetNo ][ 1 ] += (
              this.m_c_straReqData[ parm_nValSetNo ][ 0 ] + "=" +
              this.m_c_straReqData[ parm_nValSetNo ][ 1 ] +
              String.valueOf( (char)0x1e ) );
    }

    public  void    mf_do_tx( String  parm_c_strSite_CD,
                              String  parm_c_strSite_Key,
                              String  parm_c_strTx_CD,
                              String  parm_c_strCust_IP,
                              String  parm_c_strOrdr_IDxx,
                              String  parm_c_strLogLevel,
                              String  parm_c_strOpt,
                              String  parm_c_strLogPath )
    {
        String   c_strResData = "";
        int      nResDataLen;
        int      nStrInx;
        ...
        if ( this.m_bSetEnv == true )
        {
            ...
            this.m_c_strOpt        = parm_c_strOpt;
						this.m_c_strLogPath    = parm_c_strLogPath;								// 사용자 로그 변수추가 - 2013. 09. 04
...
*/
        ...
        if ( bCont == true )
        {
            try
            {
                ...
                for ( nInx = 0 ;
                      nInx < this.m_nResDataCnt &&
                      c_Token.hasMoreTokens() ;
                      nInx ++ )
                {
                    ...
                    if ( nStrInx > -1 )
                    {
                        this.m_c_straResData[ nInx ][ 0 ] =
                                             c_strTmp.substring( 0, nStrInx );
                        this.m_c_straResData[ nInx ][ 1 ] =
                                             c_strTmp.substring( nStrInx + 1 );

                        if ( this.m_c_straResData[ nInx ][ 0 ].equals( "res_cd" ) )
                        {
                            this.m_res_cd  = this.m_c_straResData[ nInx ][ 1 ];
                        }
                        else if ( this.m_c_straResData[ nInx ][ 0 ].equals( "res_msg" ) )
                        {
                            this.m_res_msg = this.m_c_straResData[ nInx ][ 1 ];
                        }
						else
					    if ( m_c_straResData[ nInx ][ 0 ].equals( "shop_status" ) )
					    {
                ...
                if ( nInx == 0 )  this.m_nResDataCnt = 0;
            }
            catch ( Exception e )
            {
                bCont = false;
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    private  String  cf_do_tx_exe()
    {
        ...
        try
        {
            ...
            c_straCmd = new String[] {
                              ...
                              "-h",
                              "home="      + this.m_c_strHomeDir   + "," +
                              "site_cd="   + this.m_c_strSite_CD   + "," +
                              "site_key="  + this.m_c_strSite_Key  + "," +
                              "tx_cd="     + this.m_c_strTx_CD     + "," +
                              "pa_url="    + this.m_c_strPAURL     + "," +
                              "pa_port="   + this.m_c_strPAPorts   + "," +
                              "ordr_idxx=" + this.m_c_strOrdr_IDxx + "," +
                              "payx_data=" + this.m_c_strPayx_Data + "," +
                              "ordr_data=" + this.m_c_strOrdr_Data + "," +
                              "rcvr_data=" + this.m_c_strRcvr_Data + "," +
                              "escw_data=" + this.m_c_strEscw_Data + "," +
                              "modx_data=" + this.m_c_strModx_Data + "," +
                              "enc_data="  + this.m_c_strEncData   + "," +
                              "enc_info="  + this.m_c_strEncInfo   + "," +
                              "trace_no="  + this.m_c_strTraceNo   + "," +
                              "cust_ip="   + this.m_c_strCust_IP   + "," +   
                              "log_path="  + this.m_c_strLogPath   + "," +                           
                              "log_level=" + this.m_c_strLogLevel  + "," +
                              "opt="       + this.m_c_strOpt       + "" 
                                     };

            c_Proc = Runtime.getRuntime().exec( c_straCmd );

            c_ExecOut = new BufferedReader( new InputStreamReader( c_Proc.getInputStream() ) );
    ...
    public String getStackTrace( Throwable aeRcv )
    {
