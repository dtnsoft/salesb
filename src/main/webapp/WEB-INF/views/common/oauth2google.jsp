	...
	function goLogin(){
	   ...
	   // alert(url.indexOf("access_token="));
	    ...
	    if (url.indexOf("access_token=") > 0) {
			...
			var restfullurl='https://www.googleapis.com/oauth2/v1/userinfo?access_token='+access_token;
			    ...
			    async:true,
			      url:  '<%= request.getContextPath() %>/common/restfullinfo?restfullurl='+encodeURIComponent(restfullurl),
			       success: function(data) {
					...
					//alert('google id : '+data.id);
					//alert('google name : '+data.name);
...
<div id="wrap" class="wrap"  >
  ...
  <input type="hidden" name="restfulltype" value="google" >
